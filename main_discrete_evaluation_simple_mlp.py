...
if __name__ == "__main__":
    ...
    for m in range(3):
        ...
        checkpoint_callback_ppo = CheckpointCallback(save_freq=10000, save_path=cf.files["model_path"],
                                                name_prefix='rl_model_09-21_mlp_v0_'+str(m))
        ...
        model.learn(total_timesteps=200000, tb_log_name="ppo_mlp_v0", callback=checkpoint_callback_ppo)  #, tb_log_name="a2c"
        ...
        with open('2022-09-21-results-ppo_mlp_v0.txt', 'w') as f:
            json.dump(final_results, f, indent=4)

        with open('2022-09-21-novelty-ppo_mlp_v0.txt', 'w') as f:
